import { type NextRequest, type NextMiddleware, type NextFetchEvent } from 'next/server';
...
export declare const identityMiddleware: (req: NextRequest, event: NextFetchEvent) => NextMiddlewareResult;
