...
const buildURL_1 = __importDefault(require("axios/unsafe/helpers/buildURL"));
const buildFullPath_1 = __importDefault(require("axios/unsafe/core/buildFullPath"));
const utils_js_1 = __importDefault(require("axios/unsafe/utils.js"));
const { isFormData, isUndefined } = utils_js_1.default;
// copied from axios v0.x
    ...
    return new Promise((resolve, reject) => {
        if (data instanceof Error) {
            ...
            Object.prototype.toString.call(config.settle) === '[object Function]'
                ...
                : (0, settle_js_1.default)(resolve, reject, data);
        }
    });
}
